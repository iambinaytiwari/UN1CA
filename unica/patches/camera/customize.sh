...
if [ -f "$FW_DIR/$TARGET_FIRMWARE_PATH/system/system/priv-app/SingleTakeService/SingleTakeService.apk" ] && \
        [ -f "$FW_DIR/$TARGET_FIRMWARE_PATH/system/system/cameradata/singletake/service-feature.xml" ]; then
